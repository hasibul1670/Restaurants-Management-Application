...
const ServedOrder = () => {
  ...
  const [selectedStatus, setSelectedStatus] = useState(""); // State variable to store the selected status
  ...
  const filteredData = orderArray?.filter((order) => order.status === "served");
  ...
  return (
    <div className="flex flex-col  w-full lg:flex-row">
      ...
      <div className="grid flex-grow justify-center h-96 card  rounded-box place-items-center  
      overflow-y-auto
      ">
